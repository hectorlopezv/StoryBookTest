...
const ToogleContext = createContext<{ ToogleShow: any; setToogleShow: any }>({
  ToogleShow: false,
  setToogleShow: () => {},
});
...
export const Accordion_Title: React.FC<Accordion_TitleProps> = ({
  children,
  ...props
}) => {
...
export const Accordion_Frame: React.FC<Accordion_ItemProps> = ({
  children,
  ...props
}) => {
...
export const Accordion_Header: React.FC<Accordion_HeaderProps> = ({
  children,
  ...props
}) => {
  const { ToogleShow, setToogleShow } = useContext<{
    ToogleShow: any;
    setToogleShow: any;
  }>(ToogleContext);
  ...
  return (
    <Header
      onClick={() => setToogleShow((latest: boolean) => !latest)}
      {...props}
    >
      {children}
      {ToogleShow ? (
...
export const Accordion_Body: React.FC<Accordion_BodyProps> = ({
  children,
  ...props
}) => {
  const { ToogleShow } = useContext<{ ToogleShow: any; setToogleShow: any }>(
    ToogleContext
  );
