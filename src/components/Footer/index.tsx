...
export const Footer_Row: React.FC<Footer_RowProps> = ({
  children,
  ...props
}) => {
...
export const Footer_Col: React.FC<Footer_ColProps> = ({
  children,
  ...props
}) => {
...
export const Footer_Link: React.FC<Footer_LinkProps> = ({
  children,
  ...props
}) => {
...
export const Footer_Title: React.FC<Footer_TitleProps> = ({
  children,
  ...props
}) => {
...
export const Footer_Text: React.FC<Footer_TextProps> = ({
  children,
  ...props
}) => {
...
export const Footer_Break: React.FC<Footer_BreakProps> = ({
  children,
  ...props
}) => {
